            ...
            <div className="w-full max-w-[440px] space-y-8 bg-white p-8 rounded-xl shadow-sm border border-slate-200">
              <div className="flex flex-col items-center text-center">
                <motion.div
                  ...
                  className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-[#13ec6d]/20 text-[#13ec6d]"
                >
              ...
              >
                ...
                <motion.button
                  whileTap={{ scale: 0.97 }}
                  type="submit"
                  className="inline-flex items-center justify-center rounded-lg bg-[#13ec6d] px-4 py-3 text-sm font-semibold text-slate-900 transition-colors hover:bg-[#13ec6d]/90 w-full shadow-lg shadow-[#13ec6d]/20"
                >
                  Log in
                </motion.button>
              </motion.form>
