    ...
    <div className="min-h-screen bg-[#f6f8f7] font-sans text-slate-900 antialiased flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-[440px] space-y-8 bg-white p-8 rounded-xl shadow-sm border border-slate-200">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-slate-900">Hisab-Rakhi</h2>
        ...
        <div className="grid grid-cols-1 gap-4">
          <button
            type="button"
            className="inline-flex items-center justify-center rounded-lg border border-slate-200 bg-white px-4 py-3 text-sm font-medium text-slate-900 hover:bg-slate-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 w-full"
          >
            <svg aria-hidden="true" className="mr-2 h-4 w-4" viewBox="0 0 488 512" xmlns="http://www.w3.org/2000/svg">
...
export default HisabRakhiLoginLight;