...
export default function AddCustomerForm({ name, setName, phone, setPhone, address, setAddress }) {
  return (
    <section className="space-y-6 px-4 py-6 bg-white">

      {/* ✅ Full Name — slide from left */}
      <motion.div
