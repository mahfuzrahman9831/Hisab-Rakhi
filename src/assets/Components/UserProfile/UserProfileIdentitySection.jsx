...
import { FiEdit2, FiEyeOff, FiEye, FiUploadCloud, FiCamera, FiCheck, FiX } from 'react-icons/fi';

// ✅ NID Card — আলাদা component
function NIDCard({ label, image, uploadRef, cameraRef, setter }) {
            ...
            {editingNID ? (
              ...
              <div className="flex items-center gap-2">
                <div className="flex-1 relative">
                  <input
                    type="text"
                    value={showNID ? nidNumber : maskedNID}
                    readOnly
                    placeholder="NID নম্বর যোগ করুন"
                    className="w-full bg-gray-50 rounded-xl py-3 px-4 pr-10 text-sm font-mono tracking-widest border border-gray-200 placeholder:text-gray-300"
                  />
                  {nidNumber && (
                    <button
