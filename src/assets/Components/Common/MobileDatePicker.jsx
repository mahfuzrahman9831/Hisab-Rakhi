...
export default function CustomCalendar({ value, onChange }) {
  ...
  <>
    ...
    {/* Calendar — screen center এ */}
    <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-[300px] bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
